            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:a0ab334a3e0a8ce85d3523b95970aa7b1fdf4d02@sha256:5370c5786ed3f574c6b8d5bede160a8db2e43e8fac3f340eb1d4b708e083fdfb"
                    }
                }
            }
        }
